...
- [ ] Ir a la carpeta donde descargaste el TP. Ejemplo: `cd /home/juan/haskell/2020-funcional-recuperatorio`. Ejecutar `stack build --test`.
- [ ] Escribir el nombre del estudiante en el archivo README.md
- [ ] Resolver el recuperatorio siguiendo [un esquema de trabajo](https://github.com/pdep-utn/enunciados-miercoles-noche/blob/master/pages/haskell/trabajo.md), eso incluye
